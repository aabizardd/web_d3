         ...
         <div class="row align-items-end">
             <div class="col-lg-8">
                 <div class="page-header-title">
                     ...
                     <div class="d-inline">
                         <h5>Dashboard PIC Asdep</h5>
                         <span>
                             Selamat datang di panel administrator PIC Asdep. Kelola segala
                             dokumentasi dan konfigurasi situs Anda di
                             sini.
                         </span>
                     </div>
                 </div>
                         ...
                         <div class="col-xl-3 col-md-6">
                             <div class="card prod-p-card card-blue">
                                 <div class="card-body">
                                     <div class="row align-items-center m-b-30">
                                         <div class="col">
                                             <h6 class="m-b-5 text-white">Total Rapat</h6>
                                             <h3 class="m-b-0 f-w-700 text-white">{{ $ct_rapat }} Rapat</h3>
                                         </div>
                                         <div class="col-auto">
                         ...
                         <div class="col-xl-3 col-md-6">
                             <div class="card prod-p-card card-green">
                                 <div class="card-body">
                                     <div class="row align-items-center m-b-30">
                                         <div class="col">
                                             <h6 class="m-b-5 text-white">Total Arsip Bahan</h6>
                                             <h3 class="m-b-0 f-w-700 text-white">{{ $ct_artikel }} Bahan</h3>
                                         </div>
                                         <div class="col-auto">
