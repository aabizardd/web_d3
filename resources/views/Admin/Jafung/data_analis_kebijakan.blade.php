<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>Data Analisis Kebijakan</h5>
        <a class="btn btn-primary" href="?page=tambah_analisis_kebijakan">
    ...
    <div class="card-block">
        ...
        <div class="dt-responsive table-responsive">
            <table id="order-table" class="table table-striped table-bordered nowrap">
                ...
                <tbody>
                    @foreach ($analis_kebijakan as $item)
                        <tr>
                            ...
                            <td style="width: 10px">
                                ...
                                <a href="{{ route('admin.hapus_analisis_kebijakan', $item->id) }}"
